...
/**
 * 
 * This activity displays results extracted from google in a list
 * 
 * @author Master
 * 
 */
public class FirstActivity extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Intent intent = new Intent(FirstActivity.this, SearchService.class);
		...
		protected ArrayList<ResultDataStructure> doInBackground(Void... params) {
			...
			if (UltimateSearchV2Activity.connectivity) {
				...
				HttpGet httpget = new HttpGet(
						"https://ajax.googleapis.com/ajax/services/search/web?v=1.0&q=%22"
				...
				try {
					...
					if (resp.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
						...
						for (i = 0; i < len; ++i) {
							...
							rds = new ResultDataStructure(obj.getString("url"),
							...
							if (fav) {
								...
								if (!c.moveToFirst()) {
									...
									if (c.getCount() < 10) {
										...
										contentvalues.put(Content.Tab, 0);
